...
type AppApi = {
  ...
  back_parser: (previousStatus?: ParserBaseStatus) => void;
...
type ParserTablesOptimizationAction = {
...
type ReducerAction =
  ...
  | ParserTablesOptimizationAction;
...
export const useIsOptimized = () => {
  return useContext(AppDataContext)!.is_optimized;
};
export const useDfa = () => {
